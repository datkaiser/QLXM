...
namespace NET_DoAn
{
    public partial class XuatHoaDon : Form
    {
        ...
        {
            dgv_dskh.DataSource = db.KhachHangs.ToList();
            //dgv_dskh.Columns[6].Visible = false;
            //dgv_dskh.Columns[7].Visible = false;
        }
        private void LoadDonhang()
        {
            dgvDonhang.DataSource = db.HoaDonXuats.ToList();
        ...
        private void btThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var qr = from d in db.HoaDonXuats
                ...
                else
                {
                    ...
                    db.HoaDonXuats.InsertOnSubmit(hdx);
                    db.SubmitChanges();
            ...
            if (MessageBox.Show("Bạn có muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                for (int i = 0; i < dgvDonhang.SelectedRows.Count; i++)
                {
                    ...
                    var qr = from d in db.HoaDonXuats
                             where d.MaHDX == st
                             select d;
                    db.HoaDonXuats.DeleteOnSubmit(qr.FirstOrDefault());
                }
                db.SubmitChanges();
        ...
        private void btSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    HoaDonXuat hdx = db.HoaDonXuats.Single(s => s.MaHDX == txtmahd.Text);
                    hdx.MaHDX = txtmahd.Text;
                    hdx.MaNV = cbManv.Text;
                    hdx.MaKH = txtMakh.Text;
                    hdx.NgayXuat = Convert.ToDateTime(txtngayxuat.Text);
        ...
        {
            Mahdx = txtmahd.Text;
            ChiTietXuat fr = new ChiTietXuat();
            fr.Show();
            this.Hide();
        }
